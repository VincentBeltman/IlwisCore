...
public:
    ...
    Q_INVOKABLE QString index2Form(quint64 metaid, bool showoutputformat, bool showEmptyOptionInList = false) const;
...
private:
    ...
    QString makeFormPart(int width, const std::vector<FormParameter> &parameters, bool input, QString &results, bool showEmptyOptionInList) const;
